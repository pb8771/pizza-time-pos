...
export async function loadSettings() {
  ...
  return {
    ...
    primaryColor: data.primary_color || "#c8102e",
    onlineHeroTitle: data.online_hero_title || "Order Online",
    onlineLogoSize: data.online_logo_size || 120,
    onlineHeroSubtitle: data.online_hero_subtitle || "Fresh, made to order — pick up or delivery",
...
export async function saveSettings(s) {
  return patch("/api/settings", {
    ...
    onlineHeroTitle: s.onlineHeroTitle,
    onlineLogoSize: s.onlineLogoSize,
    onlineHeroSubtitle: s.onlineHeroSubtitle,
    storeLat:            s.storeLat,
    storeLng:            s.storeLng,
